...
from drdroid_sdk.core.integrations.source_managers.sentry_source_manager import SentrySourceManager
...
class SentrySDK(BaseSDK):
    ...
    def fetch_issue_info_by_id(self,
        ...
        try:
            ...
            # Create task proto
            from drdroid_sdk.core.protos.playbooks.source_task_definitions.sentry_task_pb2 import Sentry
