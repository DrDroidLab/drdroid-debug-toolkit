...
from drdroid_sdk.core.integrations.source_managers.cloudwatch_source_manager import CloudwatchSourceManager
...
class CloudWatchSDK(BaseSDK):
    ...
    def execute_metric(self,
        ...
        try:
            ...
            # Create task proto
            from drdroid_sdk.core.protos.playbooks.source_task_definitions.cloudwatch_task_pb2 import Cloudwatch
