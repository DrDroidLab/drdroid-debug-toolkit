...
class WorkflowEntryPoint(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["alert_source", b"alert_source", "config", b"config", "entry_point_source", b"entry_point_source", "id", b"id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["alert_source", b"alert_source", "config", b"config", "entry_point_source", b"entry_point_source", "id", b"id", "source", b"source"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["config", b"config"]) -> typing_extensions.Literal["alert_source"] | None: ...
...
class WorkflowAction(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["action_config", b"action_config", "action_source", b"action_source", "id", b"id", "slack", b"slack"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["action_config", b"action_config", "action_source", b"action_source", "id", b"id", "slack", b"slack", "source", b"source"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["action_config", b"action_config"]) -> typing_extensions.Literal["slack"] | None: ...
