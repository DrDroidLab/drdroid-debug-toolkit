...
class SignozDashboardPanelModel(google.protobuf.message.Message):
    ...
    class Query(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["disabled", b"disabled", "id", b"id", "legend", b"legend", "name", b"name", "query", b"query"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["disabled", b"disabled", "id", b"id", "legend", b"legend", "name", b"name", "query", b"query"]) -> None: ...
