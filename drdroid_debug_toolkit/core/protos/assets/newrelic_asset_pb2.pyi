...
class NewRelicApplicationEntityAssetModel(google.protobuf.message.Message):
    ...
    class GoldenMetric(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["golden_metric_name", b"golden_metric_name", "golden_metric_nrql_expression", b"golden_metric_nrql_expression", "golden_metric_unit", b"golden_metric_unit"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["golden_metric_name", b"golden_metric_name", "golden_metric_nrql_expression", b"golden_metric_nrql_expression", "golden_metric_unit", b"golden_metric_unit"]) -> None: ...

    @typing.final
    class APMDashboard(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor

        METRIC_NAME_FIELD_NUMBER: builtins.int
        METRIC_UNIT_FIELD_NUMBER: builtins.int
        METRIC_NRQL_EXPRESSION_FIELD_NUMBER: builtins.int
        @property
        def metric_name(self) -> google.protobuf.wrappers_pb2.StringValue: ...
        @property
        def metric_unit(self) -> google.protobuf.wrappers_pb2.StringValue: ...
        @property
        def metric_nrql_expression(self) -> google.protobuf.wrappers_pb2.StringValue: ...
        def __init__(
            self,
            *,
            metric_name: google.protobuf.wrappers_pb2.StringValue | None = ...,
            metric_unit: google.protobuf.wrappers_pb2.StringValue | None = ...,
            metric_nrql_expression: google.protobuf.wrappers_pb2.StringValue | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing.Literal["metric_name", b"metric_name", "metric_nrql_expression", b"metric_nrql_expression", "metric_unit", b"metric_unit"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["metric_name", b"metric_name", "metric_nrql_expression", b"metric_nrql_expression", "metric_unit", b"metric_unit"]) -> None: ...
    ...
    APM_METRICS_FIELD_NUMBER: builtins.int
    @property
...
class NewRelicDashboardEntityAssetModel(google.protobuf.message.Message):
    ...
    class PageWidget(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["widget_id", b"widget_id", "widget_nrql_expression", b"widget_nrql_expression", "widget_title", b"widget_title", "widget_type", b"widget_type"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["widget_id", b"widget_id", "widget_nrql_expression", b"widget_nrql_expression", "widget_title", b"widget_title", "widget_type", b"widget_type"]) -> None: ...
...
class NewRelicDashboardEntityAssetOptions(google.protobuf.message.Message):
    ...
    class DashboardOptions(google.protobuf.message.Message):
        ...
        class DashboardPageOptions(google.protobuf.message.Message):
            ...
            def HasField(self, field_name: typing.Literal["page_guid", b"page_guid", "page_name", b"page_name"]) -> builtins.bool: ...
            def ClearField(self, field_name: typing.Literal["page_guid", b"page_guid", "page_name", b"page_name"]) -> None: ...
...
class NewRelicDashboardEntityAssetModelV2(google.protobuf.message.Message):
    ...
    @typing.final
    class PageWidgetV2(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor

        WIDGET_ID_FIELD_NUMBER: builtins.int
        WIDGET_TITLE_FIELD_NUMBER: builtins.int
        WIDGET_TYPE_FIELD_NUMBER: builtins.int
        WIDGET_NRQL_EXPRESSIONS_FIELD_NUMBER: builtins.int
        @property
        def widget_id(self) -> google.protobuf.wrappers_pb2.StringValue: ...
        @property
        def widget_title(self) -> google.protobuf.wrappers_pb2.StringValue: ...
        ...
        def widget_type(self) -> google.protobuf.wrappers_pb2.StringValue: ...
        @property
        def widget_nrql_expressions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.protobuf.wrappers_pb2.StringValue]: ...
        def __init__(
            self,
            *,
            widget_id: google.protobuf.wrappers_pb2.StringValue | None = ...,
            widget_title: google.protobuf.wrappers_pb2.StringValue | None = ...,
            widget_type: google.protobuf.wrappers_pb2.StringValue | None = ...,
            widget_nrql_expressions: collections.abc.Iterable[google.protobuf.wrappers_pb2.StringValue] | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing.Literal["widget_id", b"widget_id", "widget_title", b"widget_title", "widget_type", b"widget_type"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["widget_id", b"widget_id", "widget_nrql_expressions", b"widget_nrql_expressions", "widget_title", b"widget_title", "widget_type", b"widget_type"]) -> None: ...

    @typing.final
    class DashboardPageV2(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
class NewRelicDashboardEntityAssetOptionsV2(google.protobuf.message.Message):
    ...
    @typing.final
    class DashboardOptionsV2(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor

        @typing.final
        class DashboardPageOptionsV2(google.protobuf.message.Message):
            DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
class NewRelicAssetModel(google.protobuf.message.Message):
    ...
    NEW_RELIC_ENTITY_DASHBOARD_V2_FIELD_NUMBER: builtins.int
