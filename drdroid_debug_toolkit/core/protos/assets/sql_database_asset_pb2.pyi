...
class SqlDatabaseAssetModel(google.protobuf.message.Message):
    """Database asset"""
...
class SqlAssetModel(google.protobuf.message.Message):
    ...
    SQL_TABLE_FIELD_NUMBER: builtins.int
    @property
    ...
    def HasField(self, field_name: typing_extensions.Literal["asset", b"asset", "id", b"id", "sql_table", b"sql_table"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["asset", b"asset", "connector_type", b"connector_type", "id", b"id", "last_updated", b"last_updated", "sql_table", b"sql_table", "type", b"type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["asset", b"asset"]) -> typing_extensions.Literal["sql_table"] | None: ...
