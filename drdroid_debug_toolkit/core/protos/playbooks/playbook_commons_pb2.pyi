...
class PlaybookSourceOptions(google.protobuf.message.Message):
    ...
    class ConnectorOption(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["connector_id", b"connector_id", "connector_name", b"connector_name", "connector_type", b"connector_type", "display_name", b"display_name", "is_proxy_enabled", b"is_proxy_enabled", "proxy_agent_id", b"proxy_agent_id"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["connector_id", b"connector_id", "connector_name", b"connector_name", "connector_type", b"connector_type", "display_name", b"display_name", "is_proxy_enabled", b"is_proxy_enabled", "proxy_agent_id", b"proxy_agent_id"]) -> None: ...
    ...
    class TaskTypeOption(google.protobuf.message.Message):
        ...
        class SourceModelTypeMap(google.protobuf.message.Message):
            ...
            def ClearField(self, field_name: typing.Literal["display_name", b"display_name", "model_type", b"model_type"]) -> None: ...
        ...
        def ClearField(self, field_name: typing.Literal["category", b"category", "display_name", b"display_name", "form_fields", b"form_fields", "result_type", b"result_type", "supported_model_types", b"supported_model_types", "task_type", b"task_type"]) -> None: ...
