...
class MongoDB(google.protobuf.message.Message):
    ...
    class _TaskTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[MongoDB._TaskType.ValueType], builtins.type):
    ...
    class MongoQuery(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["collection", b"collection", "database", b"database", "filters", b"filters", "limit", b"limit", "order_by_field", b"order_by_field", "projection", b"projection", "timeout", b"timeout"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["collection", b"collection", "database", b"database", "filters", b"filters", "limit", b"limit", "order_by_field", b"order_by_field", "projection", b"projection", "timeout", b"timeout"]) -> None: ...
