...
class Zenduty(google.protobuf.message.Message):
    ...
    class _TaskTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Zenduty._TaskType.ValueType], builtins.type):
    ...
    class SendNote(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["note", b"note", "service", b"service"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["incident_number", b"incident_number", "note", b"note", "service", b"service"]) -> None: ...
