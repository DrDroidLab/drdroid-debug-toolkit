...
class Jira(google.protobuf.message.Message):
    ...
    class _TaskTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Jira._TaskType.ValueType], builtins.type):
    ...
    class CreateTicket(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["_assignee", b"_assignee", "_issue_type", b"_issue_type", "_labels", b"_labels", "_priority", b"_priority", "assignee", b"assignee", "description", b"description", "issue_type", b"issue_type", "labels", b"labels", "priority", b"priority", "project_key", b"project_key", "summary", b"summary"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["_assignee", b"_assignee", "_issue_type", b"_issue_type", "_labels", b"_labels", "_priority", b"_priority", "assignee", b"assignee", "description", b"description", "image_urls", b"image_urls", "issue_type", b"issue_type", "labels", b"labels", "priority", b"priority", "project_key", b"project_key", "summary", b"summary"]) -> None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing.Literal["_assignee", b"_assignee"]) -> typing.Literal["assignee"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing.Literal["_issue_type", b"_issue_type"]) -> typing.Literal["issue_type"] | None: ...
        @typing.overload
    ...
    class AssignTicket(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["assignee", b"assignee", "ticket_key", b"ticket_key"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["assignee", b"assignee", "ticket_key", b"ticket_key"]) -> None: ...
    ...
    class GetTicket(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["ticket_key", b"ticket_key"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["ticket_key", b"ticket_key"]) -> None: ...
    ...
    class AddComment(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["comment_text", b"comment_text", "ticket_key", b"ticket_key"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["comment_text", b"comment_text", "image_urls", b"image_urls", "ticket_key", b"ticket_key"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["add_comment", b"add_comment", "assign_ticket", b"assign_ticket", "create_ticket", b"create_ticket", "get_ticket", b"get_ticket", "get_users", b"get_users", "search_tickets", b"search_tickets", "task", b"task"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["add_comment", b"add_comment", "assign_ticket", b"assign_ticket", "create_ticket", b"create_ticket", "get_ticket", b"get_ticket", "get_users", b"get_users", "search_tickets", b"search_tickets", "task", b"task", "type", b"type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["task", b"task"]) -> typing.Literal["create_ticket", "assign_ticket", "get_users", "get_ticket", "search_tickets", "add_comment"] | None: ...

Global___Jira: typing_extensions.TypeAlias = Jira
