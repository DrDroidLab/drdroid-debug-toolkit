...
class Jira(google.protobuf.message.Message):
    ...
    class CreateTicket(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["_assignee", b"_assignee", "_issue_type", b"_issue_type", "_labels", b"_labels", "_priority", b"_priority", "assignee", b"assignee", "description", b"description", "issue_type", b"issue_type", "labels", b"labels", "priority", b"priority", "project_key", b"project_key", "summary", b"summary"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["_assignee", b"_assignee", "_issue_type", b"_issue_type", "_labels", b"_labels", "_priority", b"_priority", "assignee", b"assignee", "description", b"description", "image_urls", b"image_urls", "issue_type", b"issue_type", "labels", b"labels", "priority", b"priority", "project_key", b"project_key", "summary", b"summary"]) -> None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_assignee", b"_assignee"]) -> typing_extensions.Literal["assignee"] | None: ...
        @typing.overload
