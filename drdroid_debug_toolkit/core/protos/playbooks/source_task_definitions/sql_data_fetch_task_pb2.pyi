...
class SqlDataFetch(google.protobuf.message.Message):
    ...
    class _TaskTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[SqlDataFetch._TaskType.ValueType], builtins.type):
    ...
    class SqlQuery(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["database", b"database", "limit", b"limit", "offset", b"offset", "order_by_column", b"order_by_column", "query", b"query", "timeout", b"timeout"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["database", b"database", "limit", b"limit", "offset", b"offset", "order_by_column", b"order_by_column", "query", b"query", "timeout", b"timeout"]) -> None: ...
