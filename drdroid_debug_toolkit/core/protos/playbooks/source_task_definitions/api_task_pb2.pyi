...
class Api(google.protobuf.message.Message):
    ...
    class _TaskTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Api._TaskType.ValueType], builtins.type):
    ...
    class HttpRequest(google.protobuf.message.Message):
        ...
        class _MethodEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Api.HttpRequest._Method.ValueType], builtins.type):
            DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        ...
        def HasField(self, field_name: typing.Literal["cookies", b"cookies", "headers", b"headers", "payload", b"payload", "ssl_verify", b"ssl_verify", "timeout", b"timeout", "url", b"url"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["cookies", b"cookies", "headers", b"headers", "method", b"method", "payload", b"payload", "ssl_verify", b"ssl_verify", "timeout", b"timeout", "url", b"url"]) -> None: ...
