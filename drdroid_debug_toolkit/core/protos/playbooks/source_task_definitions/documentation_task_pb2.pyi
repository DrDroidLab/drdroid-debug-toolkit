...
class Documentation(google.protobuf.message.Message):
    ...
    class _TaskTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Documentation._TaskType.ValueType], builtins.type):
    ...
    class Iframe(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["iframe_url", b"iframe_url"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["iframe_url", b"iframe_url"]) -> None: ...
