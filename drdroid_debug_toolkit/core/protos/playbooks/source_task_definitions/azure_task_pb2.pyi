...
class Azure(google.protobuf.message.Message):
    ...
    class _TaskTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Azure._TaskType.ValueType], builtins.type):
    ...
    class FilterLogEvents(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["filter_query", b"filter_query", "timespan", b"timespan", "workspace_id", b"workspace_id"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["filter_query", b"filter_query", "timespan", b"timespan", "workspace_id", b"workspace_id"]) -> None: ...
    ...
    class FetchMetrics(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["aggregation", b"aggregation", "granularity", b"granularity", "metric_names", b"metric_names", "resource_id", b"resource_id", "timespan", b"timespan"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["aggregation", b"aggregation", "granularity", b"granularity", "metric_names", b"metric_names", "resource_id", b"resource_id", "timespan", b"timespan"]) -> None: ...
