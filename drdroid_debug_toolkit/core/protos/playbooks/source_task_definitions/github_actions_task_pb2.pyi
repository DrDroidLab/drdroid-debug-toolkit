...
class GithubActions(google.protobuf.message.Message):
    ...
    class _TaskTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[GithubActions._TaskType.ValueType], builtins.type):
    ...
    class FetchActionRunInfo(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["owner", b"owner", "repo", b"repo", "workflow_id", b"workflow_id"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["owner", b"owner", "repo", b"repo", "workflow_id", b"workflow_id"]) -> None: ...
