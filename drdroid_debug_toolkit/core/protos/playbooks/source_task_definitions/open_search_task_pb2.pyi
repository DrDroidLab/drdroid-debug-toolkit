...
class OpenSearch(google.protobuf.message.Message):
    ...
    class _TaskTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[OpenSearch._TaskType.ValueType], builtins.type):
    ...
    class QueryLogs(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["index", b"index", "limit", b"limit", "offset", b"offset", "query_dsl", b"query_dsl", "sort_desc", b"sort_desc", "timestamp_field", b"timestamp_field"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["index", b"index", "limit", b"limit", "offset", b"offset", "query_dsl", b"query_dsl", "sort_desc", b"sort_desc", "timestamp_field", b"timestamp_field"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["delete_index", b"delete_index", "get_cluster_health", b"get_cluster_health", "get_cluster_settings", b"get_cluster_settings", "get_cluster_stats", b"get_cluster_stats", "get_index_and_shard_recoveries", b"get_index_and_shard_recoveries", "get_index_stats", b"get_index_stats", "get_indices", b"get_indices", "get_node_stats", b"get_node_stats", "get_pending_tasks", b"get_pending_tasks", "get_shards", b"get_shards", "get_tasks", b"get_tasks", "query_logs", b"query_logs", "task", b"task"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["delete_index", b"delete_index", "get_cluster_health", b"get_cluster_health", "get_cluster_settings", b"get_cluster_settings", "get_cluster_stats", b"get_cluster_stats", "get_index_and_shard_recoveries", b"get_index_and_shard_recoveries", "get_index_stats", b"get_index_stats", "get_indices", b"get_indices", "get_node_stats", b"get_node_stats", "get_pending_tasks", b"get_pending_tasks", "get_shards", b"get_shards", "get_tasks", b"get_tasks", "query_logs", b"query_logs", "task", b"task", "type", b"type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["task", b"task"]) -> typing.Literal["query_logs", "delete_index", "get_node_stats", "get_index_stats", "get_cluster_health", "get_cluster_settings", "get_cluster_stats", "get_index_and_shard_recoveries", "get_indices", "get_pending_tasks", "get_shards", "get_tasks"] | None: ...

Global___OpenSearch: typing_extensions.TypeAlias = OpenSearch
