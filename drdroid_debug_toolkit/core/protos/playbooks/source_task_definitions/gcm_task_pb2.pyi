...
class Gcm(google.protobuf.message.Message):
    ...
    class _TaskTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Gcm._TaskType.ValueType], builtins.type):
    ...
    class MqlExecution(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["interval", b"interval", "query", b"query", "timeseries_offsets", b"timeseries_offsets"]) -> None: ...
    ...
    class DashboardView(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["dashboard_id", b"dashboard_id", "interval", b"interval", "widget_name", b"widget_name"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["dashboard_id", b"dashboard_id", "interval", b"interval", "widget_name", b"widget_name"]) -> None: ...
    ...
    class FilterLogEvents(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["filter_query", b"filter_query", "order_by", b"order_by", "page_size", b"page_size", "page_token", b"page_token"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["filter_query", b"filter_query", "order_by", b"order_by", "page_size", b"page_size", "page_token", b"page_token", "resource_names", b"resource_names"]) -> None: ...
    ...
    class SheetsDataFetch(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["max_rows", b"max_rows", "output_format", b"output_format", "sheet_name", b"sheet_name", "spreadsheet_name", b"spreadsheet_name"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["max_rows", b"max_rows", "output_format", b"output_format", "sheet_name", b"sheet_name", "spreadsheet_name", b"spreadsheet_name"]) -> None: ...
    ...
    class CloudRunServiceDashboard(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["region", b"region", "service_name", b"service_name", "widget_name", b"widget_name"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["region", b"region", "service_name", b"service_name", "widget_name", b"widget_name"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["cloud_run_service_dashboard", b"cloud_run_service_dashboard", "dashboard_view", b"dashboard_view", "filter_log_events", b"filter_log_events", "mql_execution", b"mql_execution", "sheets_data_fetch", b"sheets_data_fetch", "task", b"task"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["cloud_run_service_dashboard", b"cloud_run_service_dashboard", "dashboard_view", b"dashboard_view", "filter_log_events", b"filter_log_events", "mql_execution", b"mql_execution", "sheets_data_fetch", b"sheets_data_fetch", "task", b"task", "type", b"type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["task", b"task"]) -> typing.Literal["mql_execution", "filter_log_events", "dashboard_view", "sheets_data_fetch", "cloud_run_service_dashboard"] | None: ...

Global___Gcm: typing_extensions.TypeAlias = Gcm
