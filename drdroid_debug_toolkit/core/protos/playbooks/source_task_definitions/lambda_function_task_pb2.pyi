...
class Lambda(google.protobuf.message.Message):
    ...
    class _TaskTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Lambda._TaskType.ValueType], builtins.type):
    ...
    class Function(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["definition", b"definition", "inputs", b"inputs"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["definition", b"definition", "inputs", b"inputs", "requirements", b"requirements"]) -> None: ...
