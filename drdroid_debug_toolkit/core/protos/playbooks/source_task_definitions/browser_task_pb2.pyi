...
class Browser(google.protobuf.message.Message):
    ...
    class _TaskTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Browser._TaskType.ValueType], builtins.type):
    ...
    class Automation(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["user_prompt", b"user_prompt"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["user_prompt", b"user_prompt"]) -> None: ...
