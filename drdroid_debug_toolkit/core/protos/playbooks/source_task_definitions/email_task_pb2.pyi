...
class SMTP(google.protobuf.message.Message):
    ...
    class _TaskTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[SMTP._TaskType.ValueType], builtins.type):
    ...
    class SendEmail(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["body", b"body", "subject", b"subject", "to", b"to"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["body", b"body", "subject", b"subject", "to", b"to"]) -> None: ...
