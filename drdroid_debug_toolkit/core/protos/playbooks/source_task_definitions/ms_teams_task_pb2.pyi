...
class MSTeams(google.protobuf.message.Message):
    ...
    class _TaskTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[MSTeams._TaskType.ValueType], builtins.type):
    ...
    class SendMessageWebhook(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["payload", b"payload", "webhook", b"webhook"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["payload", b"payload", "webhook", b"webhook"]) -> None: ...
