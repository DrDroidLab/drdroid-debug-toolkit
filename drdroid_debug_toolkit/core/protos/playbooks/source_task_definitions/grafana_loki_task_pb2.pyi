...
class GrafanaLoki(google.protobuf.message.Message):
    ...
    class _TaskTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[GrafanaLoki._TaskType.ValueType], builtins.type):
    ...
    class QueryLogs(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["end_time", b"end_time", "limit", b"limit", "query", b"query", "start_time", b"start_time"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["end_time", b"end_time", "limit", b"limit", "query", b"query", "start_time", b"start_time"]) -> None: ...
