...
class Sentry(google.protobuf.message.Message):
    ...
    class _TaskTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Sentry._TaskType.ValueType], builtins.type):
    ...
    class FetchProjectEvents(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["project_slug", b"project_slug"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["project_slug", b"project_slug"]) -> None: ...
    ...
    class FetchEventInfoById(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["event_id", b"event_id", "project_slug", b"project_slug"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["event_id", b"event_id", "project_slug", b"project_slug"]) -> None: ...
    ...
    class FetchListOfRecentEventsWithSearchQuery(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["max_events_to_analyse", b"max_events_to_analyse", "project_slug", b"project_slug", "query", b"query"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["max_events_to_analyse", b"max_events_to_analyse", "project_slug", b"project_slug", "query", b"query"]) -> None: ...
    ...
    class QueryIssues(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["limit", b"limit", "project_slug", b"project_slug", "query", b"query", "stats_period", b"stats_period"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["limit", b"limit", "project_slug", b"project_slug", "query", b"query", "stats_period", b"stats_period"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["fetch_event_info_by_id", b"fetch_event_info_by_id", "fetch_issue_info_by_id", b"fetch_issue_info_by_id", "fetch_list_of_recent_events_with_search_query", b"fetch_list_of_recent_events_with_search_query", "fetch_project_events", b"fetch_project_events", "fetch_projects", b"fetch_projects", "fetch_recent_errors", b"fetch_recent_errors", "query_issues", b"query_issues", "task", b"task"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["fetch_event_info_by_id", b"fetch_event_info_by_id", "fetch_issue_info_by_id", b"fetch_issue_info_by_id", "fetch_list_of_recent_events_with_search_query", b"fetch_list_of_recent_events_with_search_query", "fetch_project_events", b"fetch_project_events", "fetch_projects", b"fetch_projects", "fetch_recent_errors", b"fetch_recent_errors", "query_issues", b"query_issues", "task", b"task", "type", b"type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["task", b"task"]) -> typing.Literal["fetch_issue_info_by_id", "fetch_project_events", "fetch_recent_errors", "fetch_event_info_by_id", "fetch_list_of_recent_events_with_search_query", "fetch_projects", "query_issues"] | None: ...

Global___Sentry: typing_extensions.TypeAlias = Sentry
