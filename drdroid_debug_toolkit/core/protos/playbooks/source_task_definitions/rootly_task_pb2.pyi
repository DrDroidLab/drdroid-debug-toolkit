...
class Rootly(google.protobuf.message.Message):
    ...
    class _TaskTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Rootly._TaskType.ValueType], builtins.type):
    ...
    class SendTimelineEvent(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["content", b"content", "incident_id", b"incident_id"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["content", b"content", "incident_id", b"incident_id"]) -> None: ...
