...
class PagerDuty(google.protobuf.message.Message):
    ...
    class _TaskTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PagerDuty._TaskType.ValueType], builtins.type):
    ...
    class SendNote(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["incident", b"incident", "note", b"note", "service", b"service"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["incident", b"incident", "note", b"note", "service", b"service"]) -> None: ...
