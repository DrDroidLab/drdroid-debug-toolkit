...
class NewRelic(google.protobuf.message.Message):
    ...
    class _TaskTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[NewRelic._TaskType.ValueType], builtins.type):
        ...
        FETCH_ALERT_CONDITIONS: NewRelic._TaskType.ValueType  # 10
    ...
    FETCH_ALERT_CONDITIONS: NewRelic.TaskType.ValueType  # 10
    ...
    class EntityApplicationGoldenMetricExecutionTask(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["application_entity_guid", b"application_entity_guid", "application_entity_name", b"application_entity_name", "golden_metric_name", b"golden_metric_name", "golden_metric_nrql_expression", b"golden_metric_nrql_expression", "golden_metric_unit", b"golden_metric_unit"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["application_entity_guid", b"application_entity_guid", "application_entity_name", b"application_entity_name", "golden_metric_name", b"golden_metric_name", "golden_metric_nrql_expression", b"golden_metric_nrql_expression", "golden_metric_unit", b"golden_metric_unit", "timeseries_offsets", b"timeseries_offsets"]) -> None: ...
    ...
    class EntityApplicationAPMDatabaseSummaryTask(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["application_entity_guid", b"application_entity_guid", "application_entity_name", b"application_entity_name", "sort_by", b"sort_by"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["application_entity_guid", b"application_entity_guid", "application_entity_name", b"application_entity_name", "sort_by", b"sort_by", "timeseries_offsets", b"timeseries_offsets"]) -> None: ...

    @typing.final
    class EntityApplicationAPMTransactionSummaryTask(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    class DashboardWidgetByIdTask(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["dashboard_name", b"dashboard_name", "unit", b"unit", "widget_id", b"widget_id"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["dashboard_name", b"dashboard_name", "timeseries_offsets", b"timeseries_offsets", "unit", b"unit", "widget_id", b"widget_id"]) -> None: ...
    ...
    class NRQLMetricExecutionTask(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["metric_name", b"metric_name", "nrql_expression", b"nrql_expression", "unit", b"unit"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["metric_name", b"metric_name", "nrql_expression", b"nrql_expression", "timeseries_offsets", b"timeseries_offsets", "unit", b"unit"]) -> None: ...
    ...
    class FetchDashboardWidgetsTask(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["dashboard_name", b"dashboard_name", "page_name", b"page_name", "unit", b"unit", "widget_names", b"widget_names"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["dashboard_name", b"dashboard_name", "page_name", b"page_name", "timeseries_offsets", b"timeseries_offsets", "unit", b"unit", "widget_names", b"widget_names"]) -> None: ...
    ...
    class GetDashboardVariableValuesTask(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["dashboard_guid", b"dashboard_guid", "variable_name", b"variable_name"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["dashboard_guid", b"dashboard_guid", "variable_name", b"variable_name"]) -> None: ...

    @typing.final
    class FetchAlertConditions(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    FETCH_ALERT_CONDITIONS_FIELD_NUMBER: builtins.int
    ...
    @property
    def fetch_alert_conditions(self) -> Global___NewRelic.FetchAlertConditions: ...
    def __init__(
        self,
        *,
        type: Global___NewRelic.TaskType.ValueType = ...,
