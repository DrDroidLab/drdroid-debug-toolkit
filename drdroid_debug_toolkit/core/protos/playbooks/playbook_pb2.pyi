...
import core.protos.playbooks.source_task_definitions.confluence_cloud_task_pb2
...
class PlaybookTask(google.protobuf.message.Message):
    ...
    CONFLUENCE_CLOUD_FIELD_NUMBER: builtins.int
    @property
    def id(self) -> google.protobuf.wrappers_pb2.UInt64Value: ...
    source: core.protos.base_pb2.Source.ValueType
    @property
    ...
    @property
    def confluence_cloud(self) -> core.protos.playbooks.source_task_definitions.confluence_cloud_task_pb2.ConfluenceCloud: ...
    def __init__(
        self,
        *,
        id: google.protobuf.wrappers_pb2.UInt64Value | None = ...,
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["task", b"task"]) -> typing_extensions.Literal["documentation", "cloudwatch", "grafana", "new_relic", "datadog", "clickhouse", "postgres", "eks", "sql_database_connection", "api", "bash", "grafana_mimir", "azure", "gke", "elastic_search", "grafana_loki", "kubernetes", "gcm", "smtp", "slack", "big_query", "mongodb", "open_search", "jenkins", "github", "sentry", "github_actions", "argocd", "jira_cloud", "lambda", "drd_proxy_agent", "posthog", "signoz", "render", "coralogix", "ops_genie", "victoria_logs", "mcp_server", "metabase", "confluence_cloud"] | None: ...
