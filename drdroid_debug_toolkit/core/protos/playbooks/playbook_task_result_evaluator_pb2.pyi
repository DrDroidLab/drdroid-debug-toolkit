...
class TimeseriesResultRule(google.protobuf.message.Message):
    ...
    class _TypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[TimeseriesResultRule._Type.ValueType], builtins.type):
...
class TableResultRule(google.protobuf.message.Message):
    ...
    class _TypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[TableResultRule._Type.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    def HasField(self, field_name: typing.Literal["column_name", b"column_name", "numeric_value_threshold", b"numeric_value_threshold", "string_value_threshold", b"string_value_threshold", "threshold", b"threshold"]) -> builtins.bool: ...
...
class BashCommandOutputResultRule(google.protobuf.message.Message):
    ...
    class _TypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[BashCommandOutputResultRule._Type.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
