...
class GlobalQueryOptions(google.protobuf.message.Message):
    ...
    @property
    def op_descriptions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[core.protos.base_pb2.OpDescription]: ...
    @property
    def op_mapping(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[core.protos.query_base_pb2.OpMapping]: ...
    @property
    def literal_type_description(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[core.protos.literal_pb2.LiteralTypeDescription]: ...
    def __init__(
        self,
        *,
        op_descriptions: collections.abc.Iterable[core.protos.base_pb2.OpDescription] | None = ...,
        op_mapping: collections.abc.Iterable[core.protos.query_base_pb2.OpMapping] | None = ...,
        literal_type_description: collections.abc.Iterable[core.protos.literal_pb2.LiteralTypeDescription] | None = ...,
    ) -> None: ...
...
class ColumnOption(google.protobuf.message.Message):
    ...
    class IdOption(google.protobuf.message.Message):
        ...
        type: core.protos.literal_pb2.IdLiteral.Type.ValueType
        @property
        ...
        def ClearField(self, field_name: typing.Literal["long_options", b"long_options", "string_options", b"string_options", "type", b"type"]) -> None: ...
...
class AttributeOption(google.protobuf.message.Message):
    ...
    class ColumnContext(google.protobuf.message.Message):
        ...
        alias: builtins.str
        @property
        def id(self) -> core.protos.literal_pb2.IdLiteral: ...
        def __init__(
            self,
            *,
            id: core.protos.literal_pb2.IdLiteral | None = ...,
            alias: builtins.str = ...,
        ) -> None: ...
        def HasField(self, field_name: typing.Literal["id", b"id"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["alias", b"alias", "id", b"id"]) -> None: ...
...
class MetricOptions(google.protobuf.message.Message):
    ...
    class AggregationFunctionOption(google.protobuf.message.Message):
        ...
        aggregation_function: core.protos.metric_pb2.AggregationFunction.ValueType
        @property
        ...
        def HasField(self, field_name: typing.Literal["label", b"label", "supports_empty_expression_selector", b"supports_empty_expression_selector"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["aggregation_function", b"aggregation_function", "label", b"label", "supports_empty_expression_selector", b"supports_empty_expression_selector"]) -> None: ...
