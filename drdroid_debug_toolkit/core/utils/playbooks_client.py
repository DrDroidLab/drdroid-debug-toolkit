...
IS_PROD_ENV = getattr(settings, 'IS_PROD_ENV', False)
MASTER_ASSETS_TOKEN = getattr(settings, 'MASTER_ASSETS_TOKEN', None)
...
if IS_PROD_ENV:
    ...
    API_TOKEN = getattr(settings, 'DRD_CLOUD_API_TOKEN', None)
