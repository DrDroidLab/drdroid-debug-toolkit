...
from core.integrations.source_metadata_extractors.databricks_metadata_extractor import DatabricksMetadataExtractor
...
source_metadata_extractor_facade.register(Source.DATABRICKS, DatabricksMetadataExtractor)
