...
from core.integrations.source_api_processors.zenduty_api_processor import ZenDutyApiProcessor
...
from core.protos.playbooks.source_task_definitions.zenduty_task_pb2 import Zenduty
...
class ZendutySourceManager(SourceManager):
    ...
    def __init__(self):
        ...
        self.connector_form_configs = [
            {
                "name": StringValue(value="Zenduty API Key Connection"),
                "description": StringValue(value="Connect to Zenduty using an API Key."),
                "form_fields": {
                    SourceKeyType.ZENDUTY_API_KEY: FormField(
                        key_name=StringValue(value=get_connector_key_type_string(SourceKeyType.ZENDUTY_API_KEY)),
                        display_name=StringValue(value="API Key"),
                        description=StringValue(value="e.g. zd_1234567890abcdef1234567890abcdef"),
                        helper_text=StringValue(value="Enter your Zenduty API Key"),
