...
class OpsGenieSourceManager(SourceManager):
    ...
    def __init__(self):
        ...
        self.task_type_callable_map = {
            ...
            OpsGenie.TaskType.CLOSE_ALERT: {
                'executor': self.close_alert,
                'result_type': PlaybookTaskResultType.API_RESPONSE,
                'display_name': 'Close Alert',
                'model_types': [],
                'category': 'Alerting',
                'form_fields': [
                    FormField(key_name=StringValue(value="alert_id"),
                              display_name=StringValue(value="Alert ID"),
                              description=StringValue(value='Enter the alert ID or alias to close'),
                              data_type=LiteralType.STRING,
                              form_field_type=FormFieldType.TEXT_FT),
                    FormField(key_name=StringValue(value="user"),
                              display_name=StringValue(value="User"),
                              description=StringValue(value='Optional user closing the alert'),
                              data_type=LiteralType.STRING,
                              form_field_type=FormFieldType.TEXT_FT,
                              is_optional=True),
                    FormField(key_name=StringValue(value="note"),
                              display_name=StringValue(value="Note"),
                              description=StringValue(value='Optional note for closing the alert'),
                              data_type=LiteralType.STRING,
                              form_field_type=FormFieldType.TEXT_FT,
                              is_optional=True),
                    FormField(key_name=StringValue(value="source"),
                              display_name=StringValue(value="Source"),
                              description=StringValue(value='Optional source of the close action'),
                              data_type=LiteralType.STRING,
                              form_field_type=FormFieldType.TEXT_FT,
                              is_optional=True),
                ]
