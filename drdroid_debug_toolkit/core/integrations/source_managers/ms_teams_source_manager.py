...
from core.integrations.source_api_processors.ms_teams_api_processor import MSTeamsApiProcessor
...
from core.protos.playbooks.source_task_definitions.ms_teams_task_pb2 import MSTeams
...
class MSTeamsSourceManager(SourceManager):
