...
from drdroid_debug_toolkit.drdroid_debug_toolkit.core.integrations.source_managers.kubernetes_source_manager import KubernetesSourceManager
...
class KubernetesSDK(BaseSDK):
    ...
    def execute_command(self,
        ...
        try:
            ...
            # Create task proto
            from drdroid_debug_toolkit.drdroid_debug_toolkit.core.protos.playbooks.source_task_definitions.kubectl_task_pb2 import Kubectl
