...
from drdroid_debug_toolkit.drdroid_debug_toolkit.core.integrations.source_managers.bash_source_manager import BashSourceManager
...
class BashSDK(BaseSDK):
    ...
    def execute_command(self,
        ...
        try:
            ...
            # Create task proto
            from drdroid_debug_toolkit.drdroid_debug_toolkit.core.protos.playbooks.source_task_definitions.bash_task_pb2 import Bash
